...
const grant = ({data, fileData, grant}) => {
	...
	let uniqueSchemeTitles = fileData.filter(obj => {return obj.category === selectedCat});
	uniqueSchemeTitles = [...new Set(uniqueSchemeTitles.map(item => item.display_title))]; 
